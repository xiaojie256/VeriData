ALTER TABLE data_submissions
  MODIFY COLUMN data_format ENUM('csv', 'excel', 'json', 'txt', 'pdf', 'word', 'archive', 'image', 'other') NOT NULL;

ALTER TABLE data_submissions
  MODIFY COLUMN ai_check_status ENUM('pending', 'running', 'completed', 'failed', 'skipped') DEFAULT 'pending';
